...
```c
anhlong@htb[/htb]$ nmap 10.129.42.253
...
```c
anhlong@htb[/htb]$ nmap -sV -sC -p- 10.129.42.253
...
```
anhlong@htb[/htb]$ locate scripts/citrix
...
```c
anhlong@htb[/htb]$ nc -nv 10.129.42.253 21
...
```c
anhlong@htb[/htb]$ nmap -sC -sV -p21 10.129.42.253
...
```c
anhlong@htb[/htb]$ ftp -p 10.129.42.253
...
```c
anhlong@htb[/htb]$ nmap --script smb-os-discovery.nse -p445 10.10.10.40
...
```c
anhlong@htb[/htb]$ nmap -A -p445 10.129.42.253
...
```c
anhlong@htb[/htb]$ smbclient -N -L \\\\10.129.42.253
...
```c
anhlong@htb[/htb]$ smbclient -U bob \\\\10.129.42.253\\users
